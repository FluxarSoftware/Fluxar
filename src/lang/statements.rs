...
pub enum Statement {
    ...
    Class { name: Token, methods: Vec<Box<Statement>>, superclass: Option<Expr> },
    Function { name: Token, params: Vec<Token>, body: Vec<Box<Statement>> },
...
impl Statement {
    ...
    pub fn to_string(&self) -> String {
        ...
        match self {
            ...
            Var { name, initializer: _ } => format!("(var {name:?})"),
